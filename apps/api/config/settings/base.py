...
MIGRATION_MODULES = {"sites": "taxinod.contrib.sites.migrations"}
...
ADMINS = [("""Valery Melou""", "admins@taxinod.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Taxinod API",
    "DESCRIPTION": "Documentation of API endpoints of Taxinod",
    "VERSION": "1.0.0",
